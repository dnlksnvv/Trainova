...
echo -e "${GREEN}=== Запуск Trainova Course Service ===${NC}"
...
# Запуск приложения
echo -e "${GREEN}Запуск Course Service на порту 8006...${NC}"
echo -e "${BLUE}Сервис будет доступен по адресу: http://localhost:8006${NC}"
